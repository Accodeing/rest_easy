...
RSpec.describe RestEasy::Types::Model do
  shared_examples_for 'raises error' do |error|
    using_test_classes do
      ...
      class TypesModelUser < RestEasy::Types::Model
  ...
  context 'without required keys' do
    include_examples 'raises error', RestEasy::MissingAttributeError do
      let(:args){ {} }
    end
  end
  ...
  context 'when omitting optional keys' do
    using_test_class do
      ...
      class User < RestEasy::Types::Model
